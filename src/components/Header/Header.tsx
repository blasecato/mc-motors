...
const Header = () => {
  ...
  const content = (
    <div className='flex'>
      ...
      <a target='_blank' href={`whatsapp://send?text=${t("header.mss")}&phone=+40745105043`} className='button-header'>
    ...
    <div className="Header" id="top">
      <div className='pre-header'>
        <div className='logos container'>
          ...
          <div className='len'>
            <a target='_blank' href={`whatsapp://send?text=${t("header.mss")}&phone=+40745105043`} className='phone'>
